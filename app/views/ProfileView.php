            ...
            <div class="col-sm-6">
             ...
             <div class="collapse" id="changeForename">
                 <div class="card card-block" >
                     <label class="col-sm-6 control-label">Neuer Vorname</label>
                     <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
             ...
             <div class="collapse" id="changeSurname">
                 <div class="card card-block" >
                     <label class="col-sm-6 control-label">Neuer Nachname</label>
                     <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
             ...
             <div class="collapse" id="changeUsername">
                 <div class="card card-block" >
                     <label class="col-sm-6 control-label">Neuer Benuztername</label>
                     <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
             ...
             <div class="collapse" id="changeEmail">
                 <div class="card card-block" >
                     <label class="col-sm-6 control-label">Neue E-Mail</label>
                     <div class="col-sm-6">
...
<div class="col-sm-offset-6 col-sm-5">
    <button class="btn btn-sm btn-default btn-block" type="submit">Passwort ändern</button>
